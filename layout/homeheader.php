...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <a class="navbar-brand fw-bold" href="<?=$baseURL?>home/index" style="font-size: 1.8rem;"> </a>
            <img src="<?=$baseURL?>/assets/images/2.png " alt="top sent" height="60">
        ...
        <!-- Header-->
        <header class="bg-dark py-5" style="position: sticky !important; top: 0;">
